...
namespace nlohmann
{
    ...
    private:
        ...
        template <typename T>
        T get(const T &def) const { return def; }

        template <>
        bool get<bool>(const bool &def) const
        {
        ...
        template <>
        uint64_t get<uint64_t>(const uint64_t &def) const
        {
        ...
        template <>
        std::string get<std::string>(const std::string &def) const
        {
